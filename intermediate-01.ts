...
// Assertions are instances when you (for whatever reason) need to tell TypeScript that you know better about the situation going on and need to essentially override its typechecking with something specific. We have actually already seen an assertion in our sample program from basics!
